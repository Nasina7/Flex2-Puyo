    ...
    <div className="mapping-data">
      ...
      <div className="properties">
        <div className="datum">
          ...
          <Input store={mapping} accessor="top" assert={isNumber} isNumber />
        </div>
        <div className="datum">
          <div className="label">left</div>
          <Input store={mapping} accessor="left" assert={isNumber} isNumber />
        </div>
        <div className="datum">
    ...
    <div className="mapping-data">
      ...
      <div className="properties">
        ...
        <div className="datum">
          ...
          <Input store={dplc} accessor="size" assert={isDPLCSize} isNumber />
        </div>
      ...
      return (
        ...
        >
          <div className="close">
            ...
            <Button color="magenta" onClick={mappingState.toggleRawEditor}>
              Close
            </Button>
          </div>
          <SortableMappingList
          ...
          {dplcsEnabled && (
            <div className="raw-dplc-data">
              ...
              <div className="buttons">
                ...
                <Item onClick={mappingState.optimizeCurrentDPLCs} inverted>
                  Optimise DPLCs
                </Item>
              </div>
            </div>
